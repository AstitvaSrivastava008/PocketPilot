...
class AnalyticsScreen(Screen):
    ...
    def load_analytics(self):
        ...
        self.ids.expense_chart.source = "assets/expense_chart.png"
        ...
        self.ids.income_expense_chart.source = "assets/income_expense_chart.png"
        ...
        self.ids.category_chart.source = "assets/category_chart.png"
        ...
        if highest:
            ...
            self.ids.highest_category.text = category
            self.ids.highest_amount.text = f"₹{amount:,.2f}"
        else:
            self.ids.highest_category.text = "No Expenses"
            self.ids.highest_amount.text = "₹0.00"
        ...
        self.ids.transaction_count_label.text = str(transaction_count)
        self.ids.category_count_label.text = str(category_count)